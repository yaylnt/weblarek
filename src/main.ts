...
console.log("Установка выбранной карточки: ", productCatalog.previewProduct = productCatalog.getById("b06cde61-912f-4663-9751-09956c0eed67"));
console.log("Получение выбранной карточки: ", productCatalog.previewProduct);
...
console.log("Добавление первого товара в корзину: ", cart.addToCart(firstProduct), cart.getCart());
console.log("Добавление второго товара в корзину: ", cart.addToCart(secondProduct), cart.getCart());
console.log("Удаление товара из корзины: ", cart.deleteFromCart("first-id"), cart.getCart());
...
buyer.saveData({payment: 'card', email: 'buyer@example.com', phone: '+79671234567', address: '123 Main St'});
console.log("Получение данных покупателя: ", buyer.getData());
console.log("Сохранение обновлённых данных: ", buyer.saveData({payment: 'cash', email: 'buyer_updated@example.com'}), buyer.getData());

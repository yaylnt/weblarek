...
[Demo](https://yaylnt.github.io/weblarek/)

### Стек
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,html,css,vite" alt="Skills" />
</p>
...
## Мой вклад в проект
- Разработала архитектуру приложения на TypeScript с использованием ООП.
- Реализовала взаимодействие слоёв приложения: Model, View и Presenter, разделив отображение, бизнес-логику и работу с данными.
- Внедрила событийную модель для взаимодействия между компонентами приложения.
- Тестировала API-запросы и ответы сервера с помощью Postman.
